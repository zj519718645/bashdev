...
homedir = os.getcwd()
rootdir = homedir + "/Deployment/sap/tm/trp"
#rootdir = "/home/build/.jenkins/jobs/hana_trp-dailybuild/workspace/Deployment/sap/tm/trp"
...
exc_obj_ref_lst = ['sap.tm.trp.db.systemmanagement.t_in_polygon','sap.tm.trp.db.booking.v_booking_extended_generated','sap.tm.trp.db.booking.v_booking_hrf',
					'sap.tm.trp.db.systemmanagement.t_geo_type','sap.tm.trp.db.systemmanagement.location.v_region_item','sap.tm.trp.db.equipment::v_resource_extended_generated']
...
for parent,dirnames,filenames in os.walk(rootdir):
	for filename in filenames:
		...
		if fl_sp_lst[1] in suffix_str_lst:
			...
			obj_ref = filename.split('/Deployment/')[1].split('.')[0].replace('/','.')
			#pdb.set_trace()
